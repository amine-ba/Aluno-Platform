...
export const SequenceItem = ({icon,color,progress,subject,concept,topic}:sequenceItemProps) => {
  return (
    ...
    <div className="font-newfont pl-10 w-64">  
  <div className={"bg-" + color + "-400 rounded lg:rounded-b-none lg:rounded-r p-4 flex flex-col justify-between"}>
  <img className="mt-3 w-10 h-2/5 " src="https://cdn.iconscout.com/icon/free/png-256/math-1963506-1657007.png" ></img>
